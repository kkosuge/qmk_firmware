 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |AltShf|  F7  |  =   |  '"  |   EI |                                       | Kana | Left | Down |  Up  | Right  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | Prev | Next |       | VolUp | Play |
 *                                 ,------|------|------|       |-------+--------+------.
 *                                 |      |      | L1   |       |VolDown|        |      |
 *                                 | Space| LCmd |------|       |-------|  Tab   |Enter |
 *                                 |      |      | L2   |       | Mute  |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LALT(KC_LSFT),  KC_F7,   KC_EQL,  KC_QUOT, LCTL(RSFT(KC_SCLN)),
                                              KC_MPRV,  KC_MNXT,
                                                                 TG(1),
                                              KC_SPC,   KC_LGUI, TG(2),
        // right hand
        KC_6,       KC_7, KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSPC,
        KC_LGUI,    KC_Y, KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT,
        KC_H,       KC_J, KC_K,    KC_L,    KC_SCLN, KC_LBRC,
        RCTL(RSFT(KC_J)), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RBRC,
