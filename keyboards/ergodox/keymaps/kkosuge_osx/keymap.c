...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
        KC_6,    KC_7, KC_8,    KC_9,    KC_0,    KC_MINS, KC_PIPE,
...
// MEDIA AND MOUSE
KEYMAP(
       KC_TRNS, LGUI(LALT(LCTL(KC_1))), LGUI(LALT(LCTL(KC_2))), LGUI(LALT(LCTL(KC_3))), LGUI(LALT(LCTL(KC_4))), LGUI(LALT(LCTL(KC_5))), LGUI(LALT(LCTL(KC_6))),
